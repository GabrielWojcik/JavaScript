...
class Cliente extends Pessoa{
    ...
    imprimir_dados(){
        super.imprimir_dados();
        console.log(`email: ${this.email} ${this.cpf} ${this.renda}`);
    }
}

const prog = new Funcao('Programador', 5989.44);
const f1 = new Funcionario('Paula', 'Fernandes','paula@gmail.com','810.201.241.87', prog,'f445');

const c1 = new Cliente('Pedro','Silveira','pedro@gmail.com','510.012.124.52',45142);
